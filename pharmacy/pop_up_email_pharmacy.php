        ...
        <div id="popup-email" class="modal">
            <div class="pop-up">
                <div id="one-more-stop">
                    <h2>One more thing before selling medicine!</h2>
                    <span class="close" href="#">&times;</span>
                </div>
                
                <div class="content">
                You have successfully created your account! 
                But to be able to log in, you must first verify your account through the link we sent in your email address.
                 This is to assure our dear Marikeños are receiving medicine from real, authorized local pharmacies.
                </div>
